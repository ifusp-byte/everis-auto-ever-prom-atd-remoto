...
@Component
public class CustomerDataFileMoveSuccessListener implements StepExecutionListener {
	...
	public void beforeStep(StepExecution stepExcution) {
		...
		String inputSuccess = "files\\Success\\";
		...
		stepExcution.getExecutionContext().put("input_success_resource", inputSuccess);
