...
class AtendimentoRemotoControllerAnexoDocumentoSimtrTestes3Test
		extends AtendimentoRemotoControllerAnexoDocumentoSimtrTest {

	@BeforeEach
	public void setUp() {
		setUpTest();
		setupIntegracao1(HttpStatus.OK.value(), "simtrDocumentosSucesso2.json", "10020030088", HttpStatus.OK.value(),
