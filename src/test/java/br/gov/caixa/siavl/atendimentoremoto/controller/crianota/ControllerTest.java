...
@RequestMapping(ControllerTest.BASE_URL)
...
class ControllerTest {
	...
	public HttpEntity<?> newRequestEntityError(Object object) {
		return new HttpEntity<Object>(object, newHttpHeadersError());
	}
	...
	public HttpHeaders newHttpHeadersError() {
		String sanitizedToken = StringUtils.normalizeSpace(StringUtils.EMPTY);
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		headers.setBearerAuth(sanitizedToken);
		return headers;
