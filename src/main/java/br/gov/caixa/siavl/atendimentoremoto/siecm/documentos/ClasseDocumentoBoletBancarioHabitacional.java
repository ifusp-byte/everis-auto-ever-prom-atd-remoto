...
public enum ClasseDocumentoBoletBancarioHabitacional implements Serializable {
	NOME_SACADO("NOME_SACADO", "Nome do Sacado", "STRING", true, 60, "", true, TipoMascara.TEXTO, null),
	ENDERECO_SACADO("ENDERECO_SACADO", "Endereço", "STRING", true, 60, "", true, null, null),
	...
	NOME_CEDENTE("NOME_CEDENTE", "Nome do Cedente", "STRING", true, 60, "", true, TipoMascara.TEXTO, null);
