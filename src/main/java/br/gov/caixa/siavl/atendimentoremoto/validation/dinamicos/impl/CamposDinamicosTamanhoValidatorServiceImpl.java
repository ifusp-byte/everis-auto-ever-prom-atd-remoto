...
public class CamposDinamicosTamanhoValidatorServiceImpl implements CamposDinamicosTamanhoValidatorService {

	@Autowired
	CampoModeloNotaRepositoryImpl campoModeloNotaRepositoryImpl;

	private final List<CamposDinamicosTamanhoValidator> camposDinamicosTamanhoValidators;

	public CamposDinamicosTamanhoValidatorServiceImpl(
			List<CamposDinamicosTamanhoValidator> camposDinamicosTamanhoValidators) {
		this.camposDinamicosTamanhoValidators = camposDinamicosTamanhoValidators;
	}

	@Override
	public List<ViolacaoDto> validateTamanho(CriaNotaInputDTO criaNotaInputDto) {

		List<List<ViolacaoDto>> lista = camposDinamicosTamanhoValidators.stream()
				.map(validator -> validator.validateTamanho(criaNotaInputDto)).filter(Optional::isPresent)
