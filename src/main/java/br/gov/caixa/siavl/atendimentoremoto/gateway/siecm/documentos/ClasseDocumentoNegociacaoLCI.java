...
public enum ClasseDocumentoNegociacaoLCI implements Serializable {
	...
	NUMERO_NOTA(new ClasseDocumentoAtributos("NUMERO_NOTA", "Número da Nota", "STRING", true, 14, "", true, TipoMascara.NUMERICO, null));

	ClasseDocumentoNegociacaoLCI(ClasseDocumentoAtributos classeDocumentoAtributos) {
	...
	ClasseDocumentoNegociacaoLCI(String classeDocumento, String nomeCampo, String tipoCampo, Boolean campoObrigatorio,
