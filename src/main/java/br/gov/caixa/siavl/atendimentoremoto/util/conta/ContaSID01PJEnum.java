...
public enum ContaSID01PJEnum {
	...
	POUPANCA_PJ_MENSAL_TRIBUTARIO_IRPF_COND_EDILICO(1388, "Poupança PJ com Remun. Mensal e Trib. de IRPF Condomínio Edilício/Determ Jud."),
	POUPANCA_PJ_PUBLICA(0146, "Poupança PJ Pública"),
	POUPANCA_PJ_PUBLICA_SEM_FINS_LUCRATIVOS_ENCERRADA_SALDO(1366, "Poupança PJ Pública Sem Fins Lucrativos encerrada com saldo encerrada com saldo"),
	...
	CONTA_PRESTACAO_CONTA_CORRESPONDENTE_CAIXA(4995, "Conta para Prestação de Conta Correspondente Caixa Aqui e a Caixa"),
	CHEQUE_ADMINISTRATIVO_PRONTO_PAGAMENTO(0020, "Cheque Administrativo Pronto Pagamento"),
