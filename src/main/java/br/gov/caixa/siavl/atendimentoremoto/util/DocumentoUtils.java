...
public class DocumentoUtils {
	...
	public static String sanitizaDocumento(String documento) {
		return documento.replace(".", "").replace("-", "").replace("/", "").trim();
	}
	...
	public static boolean isCpf(String cpfCnpj) {
		return sanitizaDocumento(cpfCnpj).length() == ONZE;
	}
	...
	public static String formatadoCpf(Object object) {
	...
	public static String formatadoCnpj(Object object) {
