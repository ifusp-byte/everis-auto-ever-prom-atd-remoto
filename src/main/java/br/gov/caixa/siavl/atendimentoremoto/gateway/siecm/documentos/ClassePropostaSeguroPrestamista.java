...
public enum ClassePropostaSeguroPrestamista implements Serializable {
	...
	NUMERO_PROPOSTA(new ClasseDocumentoAtributos("NUMERO_PROPOSTA", "Número Proposta", "STRING", true, 22, "", true, TipoMascara.NUMERO_CONTRATO,
			null));

			ClassePropostaSeguroPrestamista(ClasseDocumentoAtributos classeDocumentoAtributos) {
	...
	ClassePropostaSeguroPrestamista(String classeDocumento, String nomeCampo, String tipoCampo,
