...
public enum ClasseContratacaoCartaoVaVr implements Serializable {
	NOME_TITULAR(new ClasseDocumentoAtributos("NOME_TITULAR", "Nome do Titular", SiecmConstants.STRING, true, 256, "", true, TipoMascara.TEXTO, null)),
	...
	ClasseContratacaoCartaoVaVr(ClasseDocumentoAtributos classeDocumentoAtributos) {
	...
	ClasseContratacaoCartaoVaVr(String classeDocumento, String nomeCampo, String tipoCampo, Boolean campoObrigatorio,
