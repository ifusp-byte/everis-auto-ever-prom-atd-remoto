...
public class DataUtils {
	...
	public static Date formataDataBancoUtc() {
	...
	public static boolean isValidDate1(String dateStr) {
	...
	public static boolean isValidDate3(String dateStr) {
		...
		dataParse = dateStr.substring(0, 2) + "/" + dateStr.substring(2, 4) + "/"
				+ dateStr.substring(4, 8);

		try {
			String pattern = "dd/MM/yyyy";
			DateTimeFormatter formatter = DateTimeFormatter.ofPattern(pattern);
			LocalDate.parse(dataParse, formatter);
			return true;
		} catch (DateTimeParseException e) {
			return false;
