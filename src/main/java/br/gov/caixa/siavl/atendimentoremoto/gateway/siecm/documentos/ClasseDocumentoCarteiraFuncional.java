...
public enum ClasseDocumentoCarteiraFuncional implements Serializable {
	...
	NUMERO_REGISTRO(new ClasseDocumentoAtributos("NUMERO_REGISTRO", "Número de Registro", SiecmConstants.STRING, true, 100, "", true, TipoMascara.NUMERICO, null)),
	...
	ClasseDocumentoCarteiraFuncional(ClasseDocumentoAtributos classeDocumentoAtributos) {
	...
	ClasseDocumentoCarteiraFuncional(String classeDocumento, String nomeCampo, String tipoCampo,
