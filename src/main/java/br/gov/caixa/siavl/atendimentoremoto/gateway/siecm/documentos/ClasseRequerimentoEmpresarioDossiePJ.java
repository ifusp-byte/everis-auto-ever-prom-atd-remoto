...
public enum ClasseRequerimentoEmpresarioDossiePJ {
	...
	ClasseRequerimentoEmpresarioDossiePJ(ClasseDocumentoAtributos classeDocumentoAtributos) {
	...
	ClasseRequerimentoEmpresarioDossiePJ(String classeDocumento, String nomeCampo, String tipoCampo,
