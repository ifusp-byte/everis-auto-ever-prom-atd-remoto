...
public class CompanyHeaderTaxpayerTypeValidation implements CompanyHeaderValidator {
	...
	public CompanyHeaderTaxpayerTypeValidation(@Lazy CompanyValidatorService companyValidatorService,
	...
	public Optional<ViolationDto> validateHeader(CompanyDto company) {
		...
		if (!taxpayerType.equals(
				Util.getMessageSource(CompanyConstants.VALIDATION_COMPANY_HEADER_TIPO_CONTRIBUINTE, messageSource))) {
