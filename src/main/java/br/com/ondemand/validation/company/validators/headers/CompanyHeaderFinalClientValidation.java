...
public class CompanyHeaderFinalClientValidation implements CompanyHeaderValidator {
	...
	public CompanyHeaderFinalClientValidation(@Lazy CompanyValidatorService companyValidatorService,
	...
	public Optional<ViolationDto> validateHeader(CompanyDto company) {
		...
		if (!finalClient.equals(
				Util.getMessageSource(CompanyConstants.VALIDATION_COMPANY_HEADER_CLIENTE_FINAL, messageSource))) {
