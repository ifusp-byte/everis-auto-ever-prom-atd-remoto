package br.com.ondemand.reader;
...
import br.com.ondemand.mapper.ProductMapper;
...
public class ProductReader {
	...
	@Bean
	@StepScope
	public PoiItemReader<ProductDto> productItemReader(
			@Value("#{jobExecutionContext['productFileResource']}") String absolutePathResource) {
