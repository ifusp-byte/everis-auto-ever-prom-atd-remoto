...
import br.com.ondemand.mapper.CompanyMapper;
...
public class CompanyReader {
	...
	@Bean
	@StepScope
	public PoiItemReader<CompanyDto> companyItemReader(
			@Value("#{jobExecutionContext['companyFileResource']}") String absolutePathResource) {
