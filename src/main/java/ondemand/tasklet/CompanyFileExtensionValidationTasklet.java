...
public class CompanyFileExtensionValidationTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        chunkContext.getStepContext().getStepExecution().getExecutionContext().put(CONTEXT_COMPANY_FILE_EXTENSION_VALID, String.valueOf(absolutePathResource.endsWith(FILE_EXTENSION_XLS) || absolutePathResource.endsWith(FILE_EXTENSION_XLSX)));
